"""
第五章 5.3.4 中间件体系 — FilesystemMiddleware 示例

【章节学习重点】
- FilesystemMiddleware 的使用：通过中间件为智能体提供虚拟文件系统能力
- 虚拟文件系统在 Deep Agent 中的作用：管理中间结果和持久化数据

【代码功能】
演示 FilesystemMiddleware 的使用，让智能体通过虚拟文件系统工具
写入并读取一个说明文件。

【关键参数说明】
- FilesystemMiddleware: 文件系统中间件，提供 write_file/read_file 等工具
