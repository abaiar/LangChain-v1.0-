"""
第五章 5.3.3 人工协作 — 子智能体 HITL（Human-in-the-Loop）示例

【章节学习重点】
- 子智能体的 HITL 行为：子智能体可以有独立于主智能体的 interrupt_on 配置
- 主智能体与子智能体的审批层级：不同层级可以独立配置需要审批的工具
- interrupt_on 配置的继承与覆写：子智能体可以覆写主智能体的审批配置
...
【关键参数说明】
- interrupt_on: 配置需要人工审批的工具列表
- 子智能体可覆写主智能体的 interrupt_on 配置
