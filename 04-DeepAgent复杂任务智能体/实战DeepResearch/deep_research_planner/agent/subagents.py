"""
第五章 5.4.4 集成子图与子智能体 — 子智能体定义

【章节学习重点】
- Deep Agent 中子智能体的定义方式
- 调研子智能体和写作子智能体的分工协作

【代码功能】
子智能体定义。包含调研子智能体和写作子智能体，
供主 Agent 通过 task() 工具调用。

【关键参数说明】
- SubAgent/CompiledSubAgent: 子智能体定义方式
- task() 工具: 主 Agent 调用子智能体的入口

【应用场景】
- Deep Research 中的调研和写作分工
"""
