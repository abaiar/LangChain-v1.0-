"""
第五章 5.4.4 集成子图与子智能体 — 写作子图实现

【章节学习重点】
- 基于 LangGraph 的写作子图构建
- 子图编译为 Runnable 供 CompiledSubAgent 使用

【代码功能】
基于 LangGraph 的写作子图。将调研要点整理为结构化的 Markdown 报告，
编译为 Runnable 供 CompiledSubAgent 使用。

【应用场景】
- Deep Research 中的报告生成环节
- 结构化文档的自动生成
"""
