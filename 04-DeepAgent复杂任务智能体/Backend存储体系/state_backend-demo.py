"""
第五章 5.3.1 Backend存储体系 — StateBackend 状态后端示例

【章节学习重点】
- StateBackend 的概念：将 Agent 的状态持久化到指定后端
- Deep Agent 的状态管理机制：检查点与状态后端的关系

【代码功能】
演示 StateBackend 的使用，将 Deep Agent 的执行状态持久化。

【关键参数说明】
- StateBackend: 状态后端，负责 Agent 状态的持久化和恢复
- create_deep_agent(..., backends=[...]): 通过 backends 参数配置后端
