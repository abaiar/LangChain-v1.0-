"""
第五章 5.3.2 子智能体 — CompiledSubAgent 编译子智能体示例

【章节学习重点】
- CompiledSubAgent 的概念：预编译的子智能体，使用 LangGraph 图作为子智能体
- CompiledSubAgent vs Dictionary-based SubAgent：编译子智能体更灵活，可自定义图结构

【代码功能】
演示 CompiledSubAgent 的使用，创建包含预编译子智能体的 Deep Agent。

【关键参数说明】
- CompiledSubAgent: 编译子智能体，基于 LangGraph 图
- create_deep_agent(..., subagents=[...]): 配置编译子智能体
