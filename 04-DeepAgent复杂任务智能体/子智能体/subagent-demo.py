"""
第五章 5.3.2 子智能体 — SubAgent（Dictionary-based）示例

【章节学习重点】
- SubAgent 的概念：Deep Agent 中的子智能体，负责特定领域的任务
- 主 Agent 与子 Agent 的协作模式：主 Agent 负责协调，子 Agent 负责专业任务
- Dictionary-based 子智能体定义方式：通过字典配置子智能体

【代码功能】
演示 SubAgent 的基本使用。主 Agent 负责总体协调，
research-subagent 负责深度研究，实现主从协作。

【关键参数说明】
- SubAgent: 子智能体定义，通过字典配置
- create_deep_agent(..., subagents=[...]): 通过 subagents 参数配置子智能体
